...
count= len([500, 600, 200, 1000, 450])
...
total= sum(500, 600, 200, 1000, 450)
...
def present_value(future_value, remaining_months, annual_discount_rate): 
    pv = future_value/(1 + (annual_discount_rate * remaining_months/12))

    return pv 

pv = present_value(new_loan["futuer_value"],(new_loan)["remaining_months"]),(0.2)

# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
print(f"The present_value of teh loan is: {pv}")
...
for loan in loan_costs:
    if loan >= 500:
        ...
        print (inexpensive_loans.append)
